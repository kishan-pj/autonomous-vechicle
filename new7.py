    ...
    with tf.Session(graph=detection_graph) as sess:
        ...
        while True:
            ...
            if 'green' in detected_cone_colors and 'orange' in detected_cone_colors:
                ...
                if cone_center_line_x < frame_center_line_x:
                    print("Go right")
                elif cone_center_line_x > frame_center_line_x:
                    print("Go left")
                else:
                    frame_center_line_y = frame.shape[0] // 2
                    if prev_line_start[1] < frame_center_line_y and prev_line_end[1] > frame_center_line_y:
                        print("Go straight")
