...
while True:
    ...
    if green_cones and orange_cones:
        ...
        center_x = (green_center_x + orange_center_x) // 2

    # Draw a vertical central line
    line_color = (255, 225, 0)  # BGR color for the line (blue in this case)
    line_thickness = 2

    if center_x is not None:
        cv2.line(frame, (center_x, 0), (center_x, frame.shape[0]), line_color, line_thickness)
