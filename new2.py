...
while True:
    ...
    if center_x_cones is not None:
        cv2.line(frame, (center_x_cones, 0), (center_x_cones, frame.shape[0]), line_color, line_thickness)

        # Print instructions based on the position of the line relative to the center of the frame
        if center_x_cones < center_x:
            print("Go right")
        elif center_x_cones > center_x:
            print("Go left")
        else:
            print("Good to go")
